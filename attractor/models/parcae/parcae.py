...
from attractor.modules.injection import _get_injection_method
from attractor.modules.mixer import has_ve
...
class Parcae(torch.nn.Module):
    ...
    def __init__(
        ...
        if config.use_fused_head == "cce":
            ...
            from attractor.ops import LinearCrossEntropyLoss as LCE
