...
from experiments.attractor_puzzles.data.puzzle_dataset import (  # noqa: E402
    IGNORE_LABEL_ID,
    PuzzleDataset,
    PuzzleDatasetConfig,
)
from experiments.attractor_puzzles.trm.trm_deq import TRMDEQ  # noqa: E402
from experiments.attractor_puzzles.trm.losses_deq import ACTLossHeadDEQ  # noqa: E402
from experiments.attractor_puzzles.trm.ema import EMAHelper  # noqa: E402
from experiments.attractor_puzzles.trm.sparse_embedding import (  # noqa: E402
...
def main(cfg: TrainTRMDEQConfig):
    ...
    if cfg.evaluator == "arc":
        from experiments.attractor_puzzles.trm.arc_evaluator import ARCEvaluator
